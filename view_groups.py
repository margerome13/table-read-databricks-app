groups = [
    ...
    },
    {
        ...
        "views": [
            ...
            {
                "label": "Form-based Table Editor",
                "help": "User-friendly form interface for CRUD operations on Databricks tables.",
                "page": "views/table_form_editor.py",
                "icon": ":material/dynamic_form:",
            },
            {
                "label": "DQ MDAR Inventory Editor",
                "help": "Pre-configured form editor for the DQ MDAR Inventory Data Mart table.",
